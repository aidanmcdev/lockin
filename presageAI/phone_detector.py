...
class PhoneDetector:
    ...
    def detect(self, frame: np.ndarray, timestamp: float) -> dict:
        ...
        if (_distance(left_wrist, left_ear) < ear_threshold or
                _distance(left_wrist, right_ear) < ear_threshold or
                _distance(right_wrist, right_ear) < ear_threshold or
                _distance(right_wrist, left_ear) < ear_threshold):
            calling = True
        ...
        if (wrist_in_front(left_wrist) or wrist_in_front(right_wrist)) and head_down:
            texting = True
